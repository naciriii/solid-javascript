...
const AbstractDbManagerWithLoggableBehavior = require('./AbstractDbManagerWithLoggableBehavior');

module.exports = class FileDbManager extends AbstractDbManagerWithLoggableBehavior {
